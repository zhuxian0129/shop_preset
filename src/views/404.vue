<template>
  <div class="permission_denied" :style="{height:height+'px'}">
    <div class="denied__wrapper">
      ...
      <button class="denied__link" @click="toHome">返回首页</button>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    // window.onscroll = () => {
    //     console.log(this.height,document.documentElement.scrollTop,this.height+document.documentElement.scrollTop);
    // }
  },
  methods: {
    toHome() {
      // sessionStorage.removeItem('headerNav');
